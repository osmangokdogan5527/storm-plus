...
with open("src/components/StoklarView.tsx", "r", encoding="utf-8") as f:
    content = f.read()
...
with open("src/components/StoklarView.tsx", "w", encoding="utf-8") as f:
    f.write(content)
